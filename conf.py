...
BLOG_AUTHOR = "Innerbytes"  # (translatable)
BLOG_TITLE = "Programming"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pleasenophp.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nophp.innerbytes.com/"
BLOG_EMAIL = "info@innerbytes.com"
BLOG_DESCRIPTION = "This is a blog about programming and making life easier"  # (translatable)
...
# set this to true.
UFILE_METADATA_UNSLUGIFY_TITLES = True
